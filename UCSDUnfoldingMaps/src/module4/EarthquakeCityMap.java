...
public class EarthquakeCityMap extends PApplet {
	...
	private void printQuakes() {
		int OceanQuakes = 0;
		int listsize = quakeMarkers.size();
		int totalLandMarker = 0;
		for (Marker country : countryMarkers) {
			int LandQuakes = 0;
			String countryName = (String) country.getProperty("name");
			for (Marker quakes : quakeMarkers) {
				if (countryName == quakes.getProperty("country")) {
					LandQuakes++;
				}
			}
			if (LandQuakes != 0) {
				System.out.println(countryName + ": " + LandQuakes);
				totalLandMarker = totalLandMarker + LandQuakes;
			}
		}
		OceanQuakes = listsize - totalLandMarker;
		System.out.println("The total number of Ocean Quakes were: " + OceanQuakes);
		System.out.println("The total number of Ocean Quakes were: " + totalLandMarker);
	}
